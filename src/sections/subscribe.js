...
const Subscribe = () => {
  return (
    <Box as="section" sx={styles.subscribe}>
      <Container>
        <Heading as="h3">Subscribe The Modern Warrior Letter</Heading>
        <Text as="p">
          Join getting mindf*cked every Saturday morning while reading The
          Modern Warrior Letter
          <p>( You’ll learn a bit about life & business too.)</p>
        </Text>
